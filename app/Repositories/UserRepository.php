...
class UserRepository extends BaseRepository
{
    ...
    // func checklogin if don't use Auth

//    public function userLogin($request)
//    {
//        $emailLogin = $request['email'];
//        $emaiDB = DB::table('users')->where('email','=',$emailLogin)->first();
//        if(isset($emaiDB)) {
//            $userLogin = DB::table('users')->where('email','=',$emailLogin)->first();
//            if ($this->checkPass($userLogin, $request)) {
//                Session::put('users', $userLogin);
//                return true;
//            } else {
//                return false;
//            }
...
//    public function checkPass($userLogin, $request)
//    {
